	...
	<tr>
		...
		<tr>
			<td bgcolor='#456265' width='600' class='promocell'>                      
				...
				<multiline label='Main feature intro'><p>$s</p></multiline>
				...
				<td width='100%' bgcolor='#ffffff'>
					...
					<tr>
						<td bgcolor='#ffffff' class='contentblock'>
							...
							<h4 class='secondary'><strong><singleline label='Title'>" . $_POST[ 's' ] . "</singleline></strong></h4>
							<multiline label='Description'><p>" . $_POST[ 'm' ] . "</p></multiline>
